...
#SBATCH --job-name=testGMM1-1    # Job name
...
for dataset in "${datasets[@]}"; do
  ...
  for num_points in 5000 10000 15000 20000 25000 30000; do
    for iterations in 100000; do
      ...
      srun python train_video_GMM.py --loss_type $loss_type --dataset $dataset_path \
