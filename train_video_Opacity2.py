...
class SimpleTrainer2d:
    ...
    def __init__(
        ...
        if model_name == "GaussianImage_Cholesky":
            from gaussianimage_cholesky_Opacity2 import GaussianImage_Cholesky
            if self.isclip:
    ...
    def train(self,frame,ispos):     
        ...
        for iter in range(1, int(self.iterations)+1):
            ...
            if self.isdensity:
                if early_stopping(loss.item()) and iter>=16000:
...
def parse_args(argv):
    ...
    parser.add_argument("--removal_rate", type=float, default=0.5, help="Removal rate")
