...
srun python train_video_Full_trace_debug.py --loss_type L2 --dataset ./grey.yuv --data_name grey --num_points 1 --iterations 0 --savdir result_trace_debug --savdir_m result_trace_debug 
