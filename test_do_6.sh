...
#SBATCH --job-name=test_do_6    # Job name
...
savdir="result_density_Opacity2"
savdir_m="models_density_Opacity2"
is_pos=False
is_warmup=False
is_ad=True
is_clip=False
...
for dataset in "${datasets[@]}"; do
  ...
  for num_points in 54000 72000 90000 108000 126000; do
    for iterations in 100000; do
      ...
      srun python train_video_Opacity2.py --loss_type $loss_type --dataset $dataset_path \
