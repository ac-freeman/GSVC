...
#SBATCH --job-name=test_np_1    # Job name
...
savdir="result_density_rgbW_np"
savdir_m="models_density_rgbW_np"
is_pos=False
is_ad=True
loss_type="L2"
for dataset in "${datasets[@]}"; do
  ...
  for num_points in 60000 70000 80000; do
    for iterations in 100000; do
      ...
      srun python train_video_rnp.py --loss_type $loss_type --dataset $dataset_path \
