...
#SBATCH --job-name=testGMM4-3    # Job name
...
for dataset in "${datasets[@]}"; do
  ...
  for num_points in  40000 50000 60000; do
    for iterations in 100000; do
      ...
      srun python train_video_GMM2.py --loss_type $loss_type --dataset $dataset_path \
