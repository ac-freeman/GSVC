...
#SBATCH --job-name=test_d_p_1    # Job name
...
savdir="result_density_Grad_f"
savdir_m="models_density_Grad_f"
is_pos=False
is_warmup=False
is_ad=True
is_clip=False
...
for dataset in "${datasets[@]}"; do
  ...
  for num_points in 50000; do
    for iterations in 100000; do
      ...
      srun python train_video_ff.py --loss_type $loss_type --dataset $dataset_path \
