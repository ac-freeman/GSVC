...
srun python train_video_Full.py --loss_type L2 --dataset /home/e/e1344641/data/UVG/Beauty/Beauty_1920x1080_120fps_420_8bit_YUV.yuv --data_name Beauty --num_points 10000 --iterations 100000 --savdir test4 --savdir_m model4 --is_ad --is_rm